...
from scenario.runner.apollo_runner import ApolloRunner
...
class ScenarioRunner:
    ...
    def __init__(self, cfg: DictConfig) -> None:
        ...
        """
        self.cfg = cfg
        self.delete_record = self.cfg.delete_record
        self.force_green = self.cfg.force_green # traffic light
        self.perception_range = self.cfg.perception_range

...
from fuzzer.behavexplor.models.feature import FeatureNet
...
class CoverageModel(object):
    ...
    def _extract_feature(self, scenario: SeedWrapperClass, resample='linear'):
        y_behavior = self.feature_layer.forward(scenario, resample)
        return y_behavior

    def initialize(self, scenarios: List[SeedWrapperClass]):
        """
    ...
    def feedback_coverage_behavior(self, scenario: SeedWrapperClass):

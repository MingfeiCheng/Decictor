...
class StaticOperator(object):
    ...
    def __init__(self,
        ...
        self.noise_x = cfg.noise_x
        self.noise_y = cfg.noise_y
    ...
    def add_single_static(self, source_seed: SeedWrapper, new_id: int) -> Optional[STAgent]:
        ...
        if waypoint is None:
            ...
            static_id = new_id
            static_agent = STAgent(static_id, mutable=True, route=[waypoint], agent_type=TrafficCone(), origin_trigger=0.0, noise_trigger=0.0)
        return static_agent
    ...
    def _perturb_single_static(self,
                               agent: STAgent,
                               prohibited_region: Polygon) -> Tuple[STAgent, bool]:

...
from fuzzer.decictor_wo_remove.core.operator.static_operator import StaticOperator
from fuzzer.decictor_wo_remove.core.operator.vehicle_operator import VehicleOperator
...
class DecictorMutator:
    ...
    def _add_operator(self, next_seed: SeedWrapper) -> Tuple[SeedWrapper, bool]:
        ...
        # 1-1 Add statics
        target_count = int(random.uniform(self.min_add_static, self.max_add_static * 2))
        actual_count = 0

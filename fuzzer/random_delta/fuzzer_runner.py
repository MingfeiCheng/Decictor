...
from fuzzer.random_delta.core.fitness import OptimalFitness
from fuzzer.random_delta.core.mutator import DecictorMutator
from fuzzer.random_delta.core.oracle import OptimalOracle
from fuzzer.random_delta.core.selector import RandomSelector

class RandomDelta(object):
    def __init__(
            self,
        ...
        # config selector
        self.scenario_selector = RandomSelector(cfg_fuzzer.selector, cfg_fuzzer.population_size)
        # config oracle

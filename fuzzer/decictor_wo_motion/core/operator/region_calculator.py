...
class RegionCalculator:
    ...
    def preprocess(self, source_seed: SeedWrapper, motion_interval: float):
        ...
        # TODO: this determine the spatial region -> Motion interval
        ...
        for i, t in enumerate(self.time_list[:-1]):
            ...
            for npc_id in npc_ids:
                if npc_id == 'ego':
                    prohibit_region = self._prohibited_region_ego(self.adv_record, t, t+0.005)
                else:
                    source_record = source_seed.record
                    prohibit_region = self._prohibited_region_participant(npc_id, source_record, t, t+0.005)

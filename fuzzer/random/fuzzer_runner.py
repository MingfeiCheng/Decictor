...
from fuzzer.random.core.fitness import RandomFitness
from fuzzer.random.core.mutator import RandomMutator
from fuzzer.random.core.oracle import OptimalOracle
from fuzzer.random.core.selector import RandomSelector

from scenario.runner.scenario_runner import ScenarioRunner

class RandomFuzzer(object):
    """
    ...
    def __init__(
        ...
        # config mutator
        self.scenario_mutator = RandomMutator(cfg_fuzzer.mutator, self.refer_seed)
        # config selector
        self.scenario_selector = RandomSelector(cfg_fuzzer.population_size)
        # config oracle
        self.oracle_checker = OptimalOracle(self.refer_seed, cfg_fuzzer.oracle.optimal_threshold, cfg_fuzzer.oracle.grid_unit)
        # config fitness
        self.fitness_calculator = RandomFitness(
            self.refer_seed,
            cfg_fuzzer.fitness.mode,
            cfg_fuzzer.fitness.line_unit
        )

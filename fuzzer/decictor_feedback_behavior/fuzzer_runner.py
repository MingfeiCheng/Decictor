...
from fuzzer.decictor_feedback_behavior.core.fitness import OptimalFitness
from fuzzer.decictor.core.mutator import DecictorMutator
...
class DecictorFeedbackBehavior(object):
    """

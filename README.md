...
Considering that Decictor includes some large external files (e.g., maps), we recommend users start with the **Zenodo Source**, which contains all the necessary files.
